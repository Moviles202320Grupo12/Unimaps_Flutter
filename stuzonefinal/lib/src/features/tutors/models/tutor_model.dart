...
class TutorModel {
  ...
  /// Constructor
  const TutorModel(
      {this.id, required this.name, required this.email, required this.phoneNo,  required this.image, required this.llamadas, required this.subjects, required this.topics});
